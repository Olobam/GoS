...
function LazyUtility:LoadMenu()
	...
	self.Menu = Menu({id = "MainMenu", name = "Lazy Utility", type = MENU, leftIcon = self.Nudes.Sexy })
		self.Menu:Menu({ id = "wPtracker", name = "WayPoint Tracker", type = MENU, leftIcon = self.Nudes.wayPoints })
			self.Menu.wPtracker:Menu({ id = "toggle", name = "On / Off Toggle", key = string.byte("T"), toggle = true })
			self.Menu.wPtracker:Menu({ id = "eta", name = "Show ETA", value = true })

			self.Menu.wPtracker:Menu({ id = "showAllies", name = "Show Ally Paths", value = false })
				self.Menu.wPtracker:Menu({ id = "allyColors", name = "Ally Color", tooltip = "color and opacity for your teams paths", type = MENU, leftIcon = self.Nudes.Rainbows })
					self.Menu.wPtracker.allyColors:Menu({ id = "opacity", name = "Opacity", value = 255, min = 0, max = 255, step = 1 })
					self.Menu.wPtracker.allyColors:Menu({ id = "red", name = "Red", value = 0, min = 0, max = 255, step = 1 })
					self.Menu.wPtracker.allyColors:Menu({ id = "green", name = "Green", value = 255, min = 0, max = 255, step = 1 })
					self.Menu.wPtracker.allyColors:Menu({ id = "blue", name = "Blue", value = 0, min = 0, max = 255, step = 1 })

			self.Menu.wPtracker:Menu({ id = "showEnemies", name = "Show Enemy Paths", value = true })
				self.Menu.wPtracker:Menu({ id = "enemyColors", name = "Enemy Color", tooltip = "color and opacity for enemy teams paths", type = MENU, leftIcon = self.Nudes.Rainbows })
					self.Menu.wPtracker.enemyColors:Menu({ id = "opacity", name = "Opacity", value = 255, min = 0, max = 255, step = 1 })
					self.Menu.wPtracker.enemyColors:Menu({ id = "red", name = "Red", value = 255, min = 0, max = 255, step = 1 })
					self.Menu.wPtracker.enemyColors:Menu({ id = "green", name = "Green", value = 0, min = 0, max = 255, step = 1 })
					self.Menu.wPtracker.enemyColors:Menu({ id = "blue", name = "Blue", value = 0, min = 0, max = 255, step = 1 })

		self.Menu:Menu({ id = "mMtracker", name = "Minimap Tracker", type = MENU, leftIcon = self.Nudes.minimap })
			self.Menu.mMtracker:Menu({ id = "show", name = "MiniMap tracker", value = true, tooltip = "tracks last seen position on MiniMap" })

--Activator
		self.Menu:Menu({ id = "Activator", name = "Activator", type = MENU, leftIcon = self.Nudes.activator })
--bilgewaterCutlass
			self.Menu.Activator:Menu({ id = "bilgewaterCutlass", name = "Bilgewater Cutlass", type = MENU, leftIcon = self.Nudes.bilgewaterCutlass})
				self.Menu.Activator.bilgewaterCutlass:Menu({ id = "useBilgewaterCutlass", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.bilgewaterCutlass:Menu({ id = "bilgewaterCutlassTHP", name = "Enemy HP %", value = 40, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.bilgewaterCutlass:Menu({ id = "bilgewaterCutlassHP", name = "my Hero HP %", value = 40, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.bilgewaterCutlass:Menu({ id = "bilgewaterCutlassRange", name = "Range", value = 550, min = 0, max = 550 , step = 10, tooltip = "Target in x Range" })
--botrk
			self.Menu.Activator:Menu({ id = "botrk", name = "BotRK", type = MENU , leftIcon = self.Nudes.Botrk})
				self.Menu.Activator.botrk:Menu({ id = "useBotrk", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.botrk:Menu({ id = "botrkTHP", name = "Enemy HP %", value = 40, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.botrk:Menu({ id = "botrkHP", name = "my Hero HP %", value = 40, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.botrk:Menu({ id = "botrkRange", name = "Range", value = 550, min = 0, max = 550, step = 10, tooltip = "Target in x Range" })
--edgeOfNight
			self.Menu.Activator:Menu({ id = "edgeOfNight", name = "Edge Of Night", type = MENU, leftIcon = self.Nudes.edgeOfNight })
				self.Menu.Activator.edgeOfNight:Menu({ id = "useEdgeOfNight", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.edgeOfNight:Menu({ id = "edgeOfNightRange", name = "Range", value = 2000, min = 0, max = 2000, step = 100, tooltip = "Target in x Range" })
--frostQueensClaim
			self.Menu.Activator:Menu({ id = "frostQueensClaim", name = "Frost Queens Claim", type = MENU, leftIcon = self.Nudes.frostQueensClaim })
				self.Menu.Activator.frostQueensClaim:Menu({ id = "useFrostQueensClaim", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.frostQueensClaim:Menu({ id = "frostQueensClaimTHP", name = "Enemy HP %", value = 75, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.frostQueensClaim:Menu({ id = "frostQueensClaimHP", name = "my Hero HP %", value = 101, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.frostQueensClaim:Menu({ id = "frostQueensClaimRange", name = "Range", value = 4000, min = 0, max = 4500, step = 100, tooltip = "Target in x Range" })
--hextechGLP
			self.Menu.Activator:Menu({ id = "hextechGLP", name = "Hextech GLP-800", type = MENU, leftIcon = self.Nudes.hextechGLP })
				self.Menu.Activator.hextechGLP:Menu({ id = "useHextechGLP", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.hextechGLP:Menu({ id = "hextechGLPTHP", name = "Enemy HP %", value = 60, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.hextechGLP:Menu({ id = "hextechGLPHP", name = "my Hero HP %", value = 30, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.hextechGLP:Menu({ id = "hextechGLPRange", name = "Range", value = 400, min = 0, max = 400, step = 10, tooltip = "Target in x Range" })		
--hextechGunblade
			self.Menu.Activator:Menu({ id = "hextechGunblade", name = "Hextech Gunblade", type = MENU, leftIcon = self.Nudes.hextechGunblade })
				self.Menu.Activator.hextechGunblade:Menu({ id = "useHextechGunblade", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.hextechGunblade:Menu({ id = "hextechGunbladeTHP", name = "Enemy HP %", value = 35, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.hextechGunblade:Menu({ id = "hextechGunbladeHP", name = "my Hero HP %", value = 35, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.hextechGunblade:Menu({ id = "hextechGunbladeRange", name = "Range", value = 700, min = 0, max = 700, step = 10, tooltip = "Target in x Range" })
--hextechProtobelt
			self.Menu.Activator:Menu({ id = "hextechProtobelt", name = "Hextech Protobelt", type = MENU, leftIcon = self.Nudes.hextechProtobelt })
				self.Menu.Activator.hextechProtobelt:Menu({ id = "useHextechProtobelt", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.hextechProtobelt:Menu({ id = "hextechProtobeltTHP", name = "Enemy HP %", value = 25, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.hextechProtobelt:Menu({ id = "hextechProtobeltRange", name = "Range", value = 500, min = 0, max = 600, step = 10, tooltip = "Target in x Range" })
--redemption
			self.Menu.Activator:Menu({ id = "redemption", name = "Redemption", type = MENU, leftIcon = self.Nudes.redemption })
				self.Menu.Activator.redemption:Menu({ id = "useRedemption", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.redemption:Menu({ id = "redemptionTHP", name = "Enemy HP %", value = 11, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.redemption:Menu({ id = "redemptionHP", name = "my Hero HP %", value = 11, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.redemption:Menu({ id = "redemptionRange", name = "Range", value = 5500, min = 0, max = 5500, step = 10, tooltip = "Target in x Range" })
--zhonyas
			self.Menu.Activator:Menu({ id = "zhonyasHourglass", name = "Zhonyas Hourglass", type = MENU, leftIcon = self.Nudes.zhonyas })
				self.Menu.Activator.zhonyasHourglass:Menu({ id = "useZhonyasHourglass", name = "Use", value = true, tooltip = "general ON/OFF switch" })
				self.Menu.Activator.zhonyasHourglass:Menu({ id = "zhonyasHourglassTHP", name = "Enemy HP %", value = 101, min = 0, max = 101, step = 1, tooltip = "if Target HP% < x" })
				self.Menu.Activator.zhonyasHourglass:Menu({ id = "zhonyasHourglassHP", name = "my Hero HP %", value = 10, min = 0, max = 101, step = 1, tooltip = "My HP% < x" })
				self.Menu.Activator.zhonyasHourglass:Menu({ id = "zhonyasHourglassRange", name = "Range", value = 500, min = 0, max = 600, step = 10, tooltip = "Target in x Range" })
end
